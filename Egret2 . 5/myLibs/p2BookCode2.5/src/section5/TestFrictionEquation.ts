class TestFrictionEquation extends AbstractP2Test {
    private debugDraw: p2DebugDraw;
    private world: p2.World;

    private worldContactPoint: number[];
    private worldT: number[] = new Array();
    ...
    private addEvent(): void {
        var _this = this;
        this.world.on("preSolve", function (event: any) {
            for (var i: number = 0; i < event.frictionEquations.length; i++) {
                var frictionEquation: p2.FrictionEquation = event.frictionEquations[i];
