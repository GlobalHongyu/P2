...
var TestGetAABB = (function (_super) {
    ...
    TestGetAABB.prototype.onAppReady = function () {
        this.createWorld();
        this.createGround();
        this.createDebug();
        _super.prototype.enableMouseDrag.call(this, this.world);
    };
    TestGetAABB.prototype.createWorld = function () {
        var wrd = new p2.World();
        wrd.sleepMode = p2.World.BODY_SLEEPING;
        wrd.gravity = [0, 10];
        this.world = wrd;
    };
    TestGetAABB.prototype.createGround = function () {
    ...
    TestGetAABB.prototype.createDebug = function () {
        var sprite = new egret.Sprite();
        this.addChild(sprite);
        this.debugDraw = new p2DebugDraw(this.world, sprite);
        this.debugDraw.isDrawAABB = true;
    };
    TestGetAABB.prototype.loop = function () {
    ...
    TestGetAABB.prototype.createRectangle = function (x, y) {
        x = x / this.factor;
        y = y / this.factor;
    ...
    TestGetAABB.prototype.createCircle = function (x, y) {
        x = x / this.factor;
        y = y / this.factor;
    ...
    TestGetAABB.prototype.createTriangle = function (x, y) {
        x = x / this.factor;
        y = y / this.factor;
    ...
    TestGetAABB.prototype.onTouch = function (te) {
        switch (te.type) {
