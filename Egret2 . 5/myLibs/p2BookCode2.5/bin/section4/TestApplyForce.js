...
var TestApplyForce = (function (_super) {
    __extends(TestApplyForce, _super);
    function TestApplyForce() {
        _super.call(this);
    }
    TestApplyForce.prototype.onAppReady = function () {
        this.createWorld();
        this.createGround();
        this.createDebug();
        this.createBody();
    ...
    TestApplyForce.prototype.createWorld = function () {
        var wrd = new p2.World();
        wrd.sleepMode = p2.World.BODY_SLEEPING;
        wrd.gravity = [0, 0];
        this.world = wrd;
    };
    TestApplyForce.prototype.createGround = function () {
    ...
    TestApplyForce.prototype.createDebug = function () {
        var sprite = new egret.Sprite();
        this.addChild(sprite);
        this.debugDraw = new p2DebugDraw(this.world, sprite);
    };
    TestApplyForce.prototype.loop = function () {
    ...
    TestApplyForce.prototype.createBody = function () {
    ...
    TestApplyForce.prototype.onTouch = function (te) {
        switch (te.type) {
            ...
            case egret.TouchEvent.TOUCH_END:
                var force = new Array();
                p2.vec2.subtract(force, this.mouseStart, this.mouseEnd);
                if (force.length > 1) {
                    p2.vec2.scale(force, force, 10);
                    this.bodyRef.applyForce(force, this.mouseStart);
    ...
    return TestApplyForce;
})(AbstractP2Test);
//# sourceMappingURL=TestApplyForce.js.map