...
var TestRayCast = (function (_super) {
    ...
    TestRayCast.prototype.onAppReady = function () {
        this.createWorld();
        this.createGround();
        this.createDebug();
        this.createBodies();
    ...
    TestRayCast.prototype.createWorld = function () {
        var wrd = new p2.World();
        wrd.gravity = [0, 0];
        this.world = wrd;
    };
    TestRayCast.prototype.createGround = function () {
    ...
    TestRayCast.prototype.createDebug = function () {
        var sprite = new egret.Sprite();
        this.addChild(sprite);
        this.debugDraw = new p2DebugDraw(this.world, sprite);
    };
    TestRayCast.prototype.loop = function () {
    ...
    TestRayCast.prototype.createRectangle = function (x, y, w, h) {
        x = x / this.factor;
        y = y / this.factor;
        w = w / this.factor;
        h = h / this.factor;
    ...
    TestRayCast.prototype.createCircle = function (x, y, r) {
        x = x / this.factor;
        y = y / this.factor;
        r = r / this.factor;
    ...
    TestRayCast.prototype.createTriangle = function (x, y, w, h) {
        x = x / this.factor;
        y = y / this.factor;
        w = w / this.factor;
        h = h / this.factor;
    ...
    TestRayCast.prototype.createBodies = function () {
        var b;
