...
var TestApplyImpulse = (function (_super) {
    ...
    TestApplyImpulse.prototype.onAppReady = function () {
        this.createWorld();
        this.createGround();
        this.createDebug();
        this.createBody();
    ...
    TestApplyImpulse.prototype.createWorld = function () {
        var wrd = new p2.World();
        wrd.sleepMode = p2.World.BODY_SLEEPING;
        wrd.gravity = [0, 0];
        this.world = wrd;
    };
    TestApplyImpulse.prototype.createGround = function () {
    ...
    TestApplyImpulse.prototype.createDebug = function () {
        var sprite = new egret.Sprite();
        this.addChild(sprite);
        this.debugDraw = new p2DebugDraw(this.world, sprite);
    };
    TestApplyImpulse.prototype.loop = function () {
    ...
    TestApplyImpulse.prototype.createBody = function () {
    ...
    TestApplyImpulse.prototype.onTouch = function (te) {
        switch (te.type) {
