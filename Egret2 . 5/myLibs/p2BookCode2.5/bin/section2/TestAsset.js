...
var TestAsset = (function (_super) {
    ...
    TestAsset.prototype.onAppReady = function () {
        this.createWorld();
        this.createGround();
        this.createBodies();
        this.createDebug();
    ...
    TestAsset.prototype.createWorld = function () {
        var wrd = new p2.World();
        wrd.sleepMode = p2.World.BODY_SLEEPING;
        wrd.gravity = [0, 10];
        this.world = wrd;
    };
    TestAsset.prototype.createDebug = function () {
        var sprite = new egret.Sprite();
        this.addChild(sprite);
        this.debugDraw = new p2DebugDraw(this.world, sprite);
    };
    TestAsset.prototype.loop = function () {
        var _this = this;
    ...
    TestAsset.prototype.createGround = function () {
    ...
    TestAsset.prototype.createBodies = function () {
        this.createBox(100, 200);
        this.createDesk(300, 100);
    };
    TestAsset.prototype.createBox = function (x, y) {
        x = x / this.factor;
        y = y / this.factor;
    ...
    TestAsset.prototype.createDesk = function (x, y) {
        var _this = this;
        x = x / this.factor;
        y = y / this.factor;
    ...
    TestAsset.prototype.addOneBox = function (e) {
    ...
    TestAsset.prototype.bindAsset = function (body, assetName) {
        var offset = [];
        body.updateAABB();
